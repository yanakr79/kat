...
const MoonOrSun = styled.div`
  border: ${(p) => (p.isDark ? '4px' : '2px')} solid ${(p) => p.theme.colors.header.nav.socialLink};
  background: ${(p) => p.theme.colors.header.nav.socialLink};
  border-radius: 50%;
  height: 24px;
  ...
  &::before {
    border-radius: 50%;
    border: 2px solid ${(p) => p.theme.colors.header.nav.socialLink};
    content: '';
    height: 24px;
  ...
  &::after {
    border-radius: 50%;
    box-shadow: 0 -23px 0 ${(p) => p.theme.colors.header.nav.socialLink},
      0 23px 0 ${(p) => p.theme.colors.header.nav.socialLink},
      23px 0 0 ${(p) => p.theme.colors.header.nav.socialLink},
      -23px 0 0 ${(p) => p.theme.colors.header.nav.socialLink},
      15px 15px 0 ${(p) => p.theme.colors.header.nav.socialLink},
      -15px 15px 0 ${(p) => p.theme.colors.header.nav.socialLink},
      15px -15px 0 ${(p) => p.theme.colors.header.nav.socialLink},
      -15px -15px 0 ${(p) => p.theme.colors.header.nav.socialLink};
    content: '';
